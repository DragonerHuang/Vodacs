...
namespace Vodace.Sys.Controllers
{
    public partial class Sys_DictionaryListController
    {
        ...
        /// <returns></returns>
        [ApiActionPermission("Sys_Dictionary", Vodace.Core.Enums.ActionPermissionOptions.Export)]
        ...
        [ApiActionPermission("Sys_Dictionary", Vodace.Core.Enums.ActionPermissionOptions.Import)]
        [ApiExplorerSettings(IgnoreApi = true)]
        ...
        /// </summary>
        /// <returns></returns>
        [HttpGet, Route("GetDictionaryByCode")]
        [ApiActionPermission]
        public async Task<IActionResult> GetDictionaryByCode(string dicCode)
        {
            var result = await _service.GetDictionaryByCode(dicCode);
            return Json(result);
        }
    }
}
