...
namespace Vodace.Sys.Controllers
{
    ...
    public partial class Sys_UserController
    {
        ...
        private ISys_User_NewService _userService;
        private ICacheService _cache;
        [ActivatorUtilitiesConstructor]
        public Sys_UserController(
               ISys_UserService userService,
               ISys_User_NewService sys_User_NewService,
          ...
          : base(userService)
        {
            ...
            _userService = sys_User_NewService;
            _cache = cahce;
        }
        ...
        {
            return Json(await _userService.Login(loginInfo));
            //turn Json(await Service.Login(loginInfo));
        }
        ...
        public IActionResult UpdateUserInfo([FromBody] Sys_User user)
        {
            ...
            _userRepository.Update(user, x => new { x.UserTrueName, x.Gender, x.Remark }, true);
            return Content("修改成功");
        }
    }
}
