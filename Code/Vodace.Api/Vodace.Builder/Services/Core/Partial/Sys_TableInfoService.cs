...
using Vodace.Entity.DomainModels.Sys;
	...
	SELECT CASE WHEN t.ColumnType IN ('DECIMAL','smallmoney','money') THEN 
        ...
        private string GetMySqlStructure(string tableName)
        {
            ...
            CASE
                ...
                END AS IsKey,
            CASE
                    WHEN Column_Name IN( 'create_id', 'ModifyID', '' ) 
		            OR COLUMN_KEY<> '' THEN
                        0 ELSE 1
                        END AS IsDisplay,
		            1 AS IsColumnData,
        ...
        private string GetDMStructure(string tableName)
        {
            ...
            CASE
                ...
                END AS IsKey,
            CASE
                    WHEN tc.Column_Name IN( 'create_id', 'ModifyID', '' ) 
        ...
        private string GetSqlServerStructure(string tableName)
        {
            ...
            SELECT TableName,
                ...
                IsKey,
                CASE WHEN ColumnName IN('create_id', 'ModifyID', '')
                          OR IsKey = 1 THEN 0
                     ELSE 1
                END AS IsDisplay ,
				1 AS IsColumnData,
              ...
              CASE   WHEN ColumnType IN('time', 'date', 'DATETIME', 'smallDATETIME') THEN 150
                     ...
                     WHEN ColumnName IN('Modifier', 'create_name') THEN 130

                     WHEN ColumnType IN('int', 'bigint') OR ColumnName IN('create_id', 'ModifyID', '') THEN 80
