...
namespace Vodace.Core.ModelBinder
{
    public class BaseBinderProvider : IModelBinderProvider
    {
     ...
     //   public List<BinderObject> binder=new BinderObject()
        ...
        private void InitType()
        {
            ...
            AddType(typeof(List<Vodace.Entity.DomainModels.Sys_TableColumn>));
            AddType(typeof(Vodace.Entity.DomainModels.Sys_TableInfo));
        }
        /// <summary>
