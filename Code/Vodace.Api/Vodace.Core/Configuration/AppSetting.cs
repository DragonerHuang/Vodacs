...
namespace Vodace.Core.Configuration
{
    public static class AppSetting
    {
        ...
        public static Notice Notice { get; private set; }
        ...
        /// 文件存放路径
        /// </summary>
        public static FileSettings FileSaveSettings { get; set; }
        ...
        public static void Init(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.Configure<Notice>(configuration.GetSection("Notice"));
            ...
            Notice = provider.GetRequiredService< IOptions<Notice>>().Value;
            ...
            FileSaveSettings = provider.GetRequiredService<IOptions<FileSettings>>().Value;
    ...
    public class FileSettings
    {
        ...
        public string LeaveAttachment { get; set; }
