...
namespace Vodace.Core.Extensions
{
    public static class EntityProperties
    {
        ...
        /// <summary>
        /// 设置默认字段的值"create_id", "create_name", "CreateDate"，"ModifyID", "Modifier", "ModifyDate"
        /// </summary>
        /// <param name="saveDataModel"></param>
        /// <param name="setType">true=新增设置"create_id", "create_name", "CreateDate"值
        ...
        /// <summary>
        /// 
        /// 设置默认字段的值如:"create_id", "create_name", "CreateDate"，"ModifyID", "Modifier", "ModifyDate"
        /// </summary>
        /// <param name="saveDataModel"></param>
        /// <param name="setType">true=新增设置"create_id", "create_name", "CreateDate"值
        /// false=编辑设置"ModifyID", "Modifier", "ModifyDate"值
