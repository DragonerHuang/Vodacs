...
namespace Vodace.Core.BaseProvider
{
    public interface IRepository<TEntity> where TEntity : BaseEntity
    {
        ...
        /// <param name="selector">返回类型如:Find(x => x.user_name == loginInfo.userName, p => new { uname = p.user_name });</param>
        /// <returns></returns>
       ...
       void BulkInsert(IEnumerable<TEntity> entities, bool setOutputIdentity = false);
        ...
        ///    string value = null;
        ///    repository.WhereIF(value!=null,x=>x.create_name==value);
        ...
        /// 查询示例，value不为null时参与条件查询
        ///    string value = null;
        ///    repository.WhereIF<Sys_User>(value!=null,x=>x.create_name==value);
        /// <param name="checkCondition"></param>
        /// <param name="predicate"></param>
        /// <returns></returns>
